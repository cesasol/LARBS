...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/cesasol/voidrice.git" && repobranch="archi3"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/cesasol/LARBS/master/archi3/progs.csv"
